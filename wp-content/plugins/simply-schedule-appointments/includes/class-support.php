...
class SSA_Support {
	...
	public function reset_settings() {
		...
		$options_to_delete = array(
			...
			'ssa_settings_json',
			'ssa_versions',
			'wp_ssa_resource_appointments_db_version',
			'wp_ssa_resource_group_appointment_types_db_version',
			'wp_ssa_resources_db_version',
			'wp_ssa_resource_groups_db_version',
			'wp_ssa_resource_group_resources_db_version',
			'wp_ssa_appointment_type_labels_db_version',
			'wp_ssa_revisions_db_version',
			'wp_ssa_revision_meta_db_version',
			'wp_ssa_availability_external_db_version',
			'wp_ssa_staff_db_version',
			'wp_ssa_staff_appointments_db_version',
			'wp_ssa_staff_appointment_types_db_version',
		);
